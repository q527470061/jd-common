package com.jd.util.verifycode;
...
public class VerifyCode {
	...
	private Font randomFont() {
		int index = r.nextInt(fontNames.length);//获取数字长度，获取下标
	...
	//随机生成一个字体名称
		...
		int index1 = r.nextInt(fontNames.length);
	...
	public BufferedImage getImage(){
		...
		this.text = sb.toString();//把生成的字符串付给了this.text
